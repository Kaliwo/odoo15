(module
 ...
 (global $assembly/main/purchaseOrders (mut i32) (i32.const 0))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18268))
 (memory $0 1)
 ...
 (data (i32.const 1512) "\01\00\00\00\04\00\00\00p\00o")
 (data (i32.const 1532) ",")
 ...
 (data (i32.const 1768) "\01\00\00\00:\00\00\00~\00l\00i\00b\00/\00n\00e\00a\00r\00-\00s\00d\00k\00-\00c\00o\00r\00e\00/\00s\00t\00o\00r\00a\00g\00e\00.\00t\00s")
 (data (i32.const 1840) "\05\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1876) "A\00\00\00\02")
 (export "memory" (memory $0))
 (export "storePurchaseOrder" (func $export:assembly/main/storePurchaseOrder))
 (export "getPurchaseOrder" (func $export:assembly/main/getPurchaseOrder))
 (start $~start)
 ...
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $assembly/main/purchaseOrders
  local.tee $0
  if
   local.get $0
 ...
 (func $~lib/near-sdk-core/collections/persistentMap/PersistentMap<~lib/string/String,~lib/string/String>#set:_elementPrefix (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  i32.store
    ...
    block $~lib/typedarray/Uint8Array
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $~lib/typedarray/Uint8Array $invalid
      end
      return
     end
     return
 ...
 (func $~start
  ...
  local.get $0
  i32.const 0
  call $~lib/near-sdk-core/collections/persistentMap/PersistentMap<~lib/string/String,~lib/string/String>#set:_elementPrefix
  global.get $~lib/memory/__stack_pointer
  i32.const 1056
  i32.store offset=4
  local.get $0
  ...
  global.set $~lib/memory/__stack_pointer
  local.get $0
  global.set $assembly/main/purchaseOrders
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $~lib/near-sdk-core/collections/persistentMap/PersistentMap<~lib/string/String,~lib/string/String>#_key (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/main/storePurchaseOrder (param $0 i32) (param $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $2
  local.get $0
  call $~lib/near-sdk-core/collections/persistentMap/PersistentMap<~lib/string/String,~lib/string/String>#_key
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
  i32.store
 ...
 (func $export:assembly/main/getPurchaseOrder (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $0
  i32.store offset=4
  block $__inlined_func$assembly/main/getPurchaseOrder
   local.get $0
   if
    global.get $~lib/memory/__stack_pointer
    i32.const 8
    i32.add
    global.set $~lib/memory/__stack_pointer
    br $__inlined_func$assembly/main/getPurchaseOrder
   end
   global.get $~lib/memory/__stack_pointer
   i32.const 8
   i32.add
